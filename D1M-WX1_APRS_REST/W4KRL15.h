...
const float dmmVoltage = 4.66;       // voltage displayed on your digital multimeter
const float adcVoltage = 4.72;       // voltage reported by the D1 Mini Analog to Digital Converter
...
const long CHANNEL_ID = 286120;
const String API_WRITE_KEY = "8R6HHUISXEYBO4Q0";
